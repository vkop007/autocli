...
export function getPlatformCategories(): readonly PlatformCategory[] {
  const order: readonly PlatformCategory[] = ["llm", "ai", "editor", "finance", "data", "google", "maps", "movie", "news", "music", "social", "careers", "shopping", "developer", "devops", "bot", "tools", "forum"];
