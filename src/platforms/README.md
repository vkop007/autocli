...
- Active browserless LLM platforms: `src/platforms/llm/gemini/`, `src/platforms/llm/zai/`
- Experimental LLM scaffolds kept out of the CLI until they have proven browserless flows: `src/platforms/llm/chatgpt/`, `src/platforms/llm/grok/`
